...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    setIsLoading(true);
    // In future: Redirect to Google OAuth
    // window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/auth/google`;
    
    // Placeholder: Simulate login and redirect to dashboard
    setTimeout(() => {
        ...
        <div className="glass-strong rounded-3xl p-8 md:p-10 space-y-8">
          ...
          >
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-6 py-4 font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            >
