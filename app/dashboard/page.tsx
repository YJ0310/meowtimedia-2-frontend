                ...
                >
                  <Link href={`/country/${country.slug}`}>
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full bg-gradient-primary text-white py-4 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-xl hover:shadow-2xl transition-shadow"
                    >
            ...
            >
              ...
              <div className="px-4 pb-8 space-y-4 overflow-y-auto max-h-[calc(85vh-48px)]">
                ...
                <Link href={`/country/${country.slug}`}>
                  <motion.button
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-gradient-primary py-4 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-xl"
                  >
                    Explore {country.name}
                    <ArrowRight className="w-5 h-5" />
                  </motion.button>
